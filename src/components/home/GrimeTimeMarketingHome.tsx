  ...
  return (
    <div className="w-full">
      <section className="relative overflow-hidden border-b border-border/70">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-14 px-6 py-14 md:py-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] lg:items-center lg:gap-18">
          <div className="max-w-3xl">
            <p className="text-[0.7rem] font-semibold uppercase tracking-[0.34em] text-primary/80">
              Grime Time exterior cleaning
            </p>
            <h1 className="mt-4 text-5xl font-semibold leading-[0.92] tracking-[-0.04em] text-foreground md:text-7xl">
              Clear scope.
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2.3rem] border border-white/10 bg-[#071321] p-4 text-white shadow-[0_32px_100px_-40px_rgba(2,6,23,0.95)]">
              {heroImageUrl ? (
                ...
                <div className="flex aspect-[4/5] items-end rounded-[1.6rem] bg-[linear-gradient(180deg,#11314d,#071321)] p-6">
            ...
            {featuredServices[2] ? (
              <div className="absolute -left-4 top-10 hidden w-48 rounded-[1.5rem] border border-border/70 bg-card/92 p-4 shadow-[0_22px_70px_-45px_rgba(2,6,23,0.95)] backdrop-blur lg:block">
