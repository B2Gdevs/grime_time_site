...
function getDefaultUserMessage(appId: string): string {
  const messages: Record<string, string> = {
    ...
    "service-grid":
      "Show me the service grid block with the pricing steps fixture.",
...
function getDefaultAssistantResponse(appId: string): string {
  const responses: Record<string, string> = {
    ...
    "service-grid":
      "I switched the preview to the pricing steps fixture. You can edit the JSON input to swap copy, media, or the display variant.",
  };
  return (
    responses[appId] ??
