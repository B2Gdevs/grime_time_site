...
import { SERVICE_GRID_DEMO_INPUT } from "@/lib/workbench/demo/default-props";
import { componentConfigs } from "./component-configs";
import { ServiceGridSDK } from "./wrappers";
...
> = {
  "service-grid": {
    component: ServiceGridSDK,
    defaultProps: SERVICE_GRID_DEMO_INPUT,
  },
};
